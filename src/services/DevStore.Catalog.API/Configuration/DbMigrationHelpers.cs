...
namespace DevStore.Catalog.API.Configuration
{
    ...
    public static class DbMigrationHelpers
    {
        ...
        private static async Task EnsureSeedProducts(CatalogContext context)
        {
            ...
            await context.Products.AddAsync(new Product() { Name = "T-Shirt Code Life Preta", Description = "T-Shirt 100% cotton, high durable to wash and high temperatures washing.", Active = true, Price = 50.00M, DateAdded = DateTime.Now, Image = "camiseta2.jpg", Stock = 10 });
            ...
            await context.Products.AddAsync(new Product() { Name = "Mug Wonder Woma", Description = "Porcelain mug with high-strength thermal printing.", Active = true, Price = 50.00M, DateAdded = DateTime.Now, Image = "caneca-Wonder Woman.jpg", Stock = 10 });
            await context.Products.AddAsync(new Product() { Name = "Mug No Coffee No Code", Description = "Porcelain mug with high-strength thermal printing.", Active = true, Price = 50.00M, DateAdded = DateTime.Now, Image = "Mug4.jpg", Stock = 10 });
            await context.Products.AddAsync(new Product() { Name = "Mug Batma", Description = "Porcelain mug with high-strength thermal printing.", Active = true, Price = 50.00M, DateAdded = DateTime.Now, Image = "caneca1--batman.jpg", Stock = 5 });
            ...
            await context.Products.AddAsync(new Product() { Name = "Mug Batman Preta", Description = "Porcelain mug with high-strength thermal printing.", Active = true, Price = 50.00M, DateAdded = DateTime.Now, Image = "caneca-Batman.jpg", Stock = 8 });
            ...
            await context.Products.AddAsync(new Product() { Name = "Mug Cogumelo", Description = "Porcelain mug with high-strength thermal printing.", Active = true, Price = 50.00M, DateAdded = DateTime.Now, Image = "caneca-cogumelo.webp", Stock = 10 });
            ...
            await context.Products.AddAsync(new Product() { Name = "Mug Ironma", Description = "Porcelain mug with high-strength thermal printing.", Active = true, Price = 50.00M, DateAdded = DateTime.Now, Image = "caneca-ironman.jpg", Stock = 10 });
            await context.Products.AddAsync(new Product() { Name = "T-Shirt Debugar Preta", Description = "T-Shirt 100% cotton, high durable to wash and high temperatures washing.", Active = true, Price = 75.00M, DateAdded = DateTime.Now, Image = "camiseta4.jpg", Stock = 10 });
            await context.Products.AddAsync(new Product() { Name = "T-Shirt Code Life Cinza", Description = "T-Shirt 100% cotton, high durable to wash and high temperatures washing.", Active = true, Price = 99.00M, DateAdded = DateTime.Now, Image = "camiseta3.jpg", Stock = 3 });
