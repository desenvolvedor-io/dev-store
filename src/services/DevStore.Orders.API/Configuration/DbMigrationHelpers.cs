...
public static class DbMigrationHelpers
{
    ...
    private static async Task EnsureSeedVouchers(OrdersContext context)
    {
        ...
        await context.Vouchers.AddAsync(new Voucher("30-OFF", 30, 0, 5000, VoucherDiscountType.Percentage,
            DateTime.Now.AddYears(5)));
        await context.Vouchers.AddAsync(new Voucher("50-OFF", 0, 50, 5000, VoucherDiscountType.Value,
            DateTime.Now.AddYears(5)));
